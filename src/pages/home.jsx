      ...
      <div className="page-wrapper">
              ...
              <div className="nav-outer d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div className="select-categories">
                  <div className="category">
                    <span className="icon flaticon-menu-3"></span> Select
                    categories{" "}
                    <span className="arrow flaticon-down-arrow"></span>
                  </div>
                ...
                {/* <!-- Outer Box --> */}
                <div className="outer-box d-flex justify-content-between align-items-center me-4">
                  {/* <!-- Social Box --> */}
                  {/* <div className="language dropdown">
                    ...
                    >
                      ...
                      English &nbsp;<span className="fa fa-angle-down"></span>
                    </button>
                     <div
        ...
        {/* <div className="py-5 my-5 categories">
          ...
          <div className="container my-4">
            <div className="row " style={{ rowGap: "20px" }}>
              <div
                className="col-md-6 zoom-container "
                onClick={() => {
                  navigate("/shop?category=mattress");
                }}
              >
                <div
                  className="categorycard1 card "
                  style={{
                    display: "flex",
                    flexDirection: "row",
                    alignItems: "end",
                ...
                >
                  <div className="card-body">
                    <h5 className="card-title text-light pb-3 ps-4">Mattresses</h5>
                  </div>
                </div>
              </div>
              <div
              ...
              >
                ...
                >
                  <div className="card-body">
                    <h5 className="card-title text-dark pb-3 ps-4">Toppers</h5>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className=" mx-4 ">
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4">
            <h2 className="h2  text-center bgp w-100">Shop by Category</h2>
          ...
          <Layout>
            <div className="row g-4">
              <div
                ...
                style={{ cursor: "pointer" }}
              >
                <div className="p-4 bg-light dark:bg-dark rounded tre">
                  <img
                    ...
                    className="mb-2"
                  />
                  <h3 className="h4 fw-bold mb-1">Mattress</h3>
                  <p className="text-muted">Comfortable and supportive.</p>
                </div>
              </div>
              <div
                className="col-12 col-sm-6 col-lg-3"
              ...
              >
                <div className="p-4 bg-light dark:bg-dark rounded">
                  <img
                    ...
                    className="mb-2"
                  />
                  <h3 className="h4 fw-bold mb-1">Toppers</h3>
                  <p className="text-muted">Enhance your sleep quality.</p>
                </div>
              </div>
              <div
                className="col-12 col-sm-6 col-lg-3"
              ...
              >
                <div className="p-4 bg-light dark:bg-dark rounded">
                  <img
                    ...
                    className="mb-2"
                  />
                  <h3 className="h4 fw-bold mb-1">Cushion</h3>
                  <p className="text-muted">Comfort for every seat.</p>
                </div>
              </div>
              <div
                className="col-12 col-sm-6 col-lg-3"
              ...
              >
                <div className="p-4 bg-light dark:bg-dark rounded">
                  <img
                    ...
                    className="mb-2"
                  />
                  <h3 className="h4 fw-bold mb-1">Pillow</h3>
                  <p className="text-muted">Support for every sleeper.</p>
                </div>
              </div>
            </div>
          </Layout>
        ...
        <div className="vw-100 mt-2 pt-4">
          <h3 className=" ms-3 mb-5 text-center  fs-4 w-full text-primary ">
            Sleep <span className=" ">reimagined</span>, your story begins with{" "}
            <span className="text-danger ms-1">Axion</span>
            <span className="text-dange ms-1">Foam</span>
          </h3>
        </div>
        {/* <Layout> */}
