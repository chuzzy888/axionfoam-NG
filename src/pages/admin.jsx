...
export const Admin = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const data = await axios.post(
        "https://axionbackend.betsphere.com.ng/api/addproduct",
  ...
  const handleProductDelete = async (id, name) => {
    try {
      const response = await axios.delete(
        `https://axionbackend.betsphere.com.ng/api/deleteproduct/${id}`
      );
  ...
  const addProductImage = async (id, images) => {
    try {
      ...
      const response = await axios.put(
        "https://axionbackend.betsphere.com.ng/api/addproductimage",
  ...
  const updateProduct = async () => {
    try {
      ...
      const response = await axios.put(
        "https://axionbackend.betsphere.com.ng/api/updatename",
        {
          id: editingId,
          name,
          category,
  ...
  const getAllOrders = async () => {
    try {
      const newData = await axios.get(
        `https://axionbackend.betsphere.com.ng/api/getallorders`
      );
      console.log(newData);
  ...
  const handleDelivered = async (id, newStatus) => {
    ...
    try {
      const newData = await axios.post(
        `https://axionbackend.betsphere.com.ng/api/changedelivered`,
        {
          orderId: id,
          newStatus,
        }
  ...
  const handleSpam = async (id, newStatus) => {
    ...
    try {
      const newData = await axios.post(
        `https://axionbackend.betsphere.com.ng/api/changespam`,
        {
          orderId: id,
          newStatus,
        }
  ...
  const getAllUsersLen = async () => {
    ...
    try {
      const newData = await axios.get(
        `https://axionbackend.betsphere.com.ng/api/getallusers`
      );
  ...
  const getMessages = async () => {
    ...
    try {
      const newData = await axios.get(
        `https://axionbackend.betsphere.com.ng/api/getmessages`
      );
  ...
  const getAllProductsLen = async () => {
    ...
    try {
      const newData = await axios.get(
        `https://axionbackend.betsphere.com.ng/api/getallproducts`
      );
  ...
  const getAllOrdersLen = async () => {
    ...
    try {
      const newData = await axios.get(
        `https://axionbackend.betsphere.com.ng/api/getallorderslen`
      );
  ...
  const getPendingOrders = async () => {
    ...
    try {
      const newData = await axios.get(
        `https://axionbackend.betsphere.com.ng/api/getpendingorders`
      );
  ...
  const getMessageslen = async () => {
    ...
    try {
      const newData = await axios.get(
        `https://axionbackend.betsphere.com.ng/api/getallMessageslen`
      );
  ...
  const getSettledOrders = async () => {
    ...
    try {
      const newData = await axios.get(
        `https://axionbackend.betsphere.com.ng/api/getsettledorders`
      );
              ...
              return (
                ...
                >
                  <div className="eachsize">
                    ...
                    <p>
                      Price <span>{eachsize.price}</span>
                    </p>
                    <p className="!uppercase">
        ...
        <Modal show={showOrder} onHide={handleCloseOrder}>
          ...
          <Modal.Body>
            <div className="pb-5">
              ...
              <p className="text-dark">Price: ₦{orderShowing?.price}</p>
