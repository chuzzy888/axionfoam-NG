...
export const Register = () => {
  ...
  const register = async () => {
    try {
      setLoading(true);
      if (!email || !password || !confirmPassword || !recoveryAnswer) {
      ...
      if (password.length <= 6) {
        throw new Error("Minimum length of password is 7");
      }
      ...
      const data = await axios.post(
        ...
        "https://axionbackend.betsphere.com.ng/api/register",
        {
          email,
          password,
          recoveryQuestion: "What is your favourite food",
            ...
            <div className="row justify-content-center">
              <div className="col-md-12 col-lg-10">
                <div className="wrap d-md-flex">
                  <div
                    className="img"
                    style={{ backgroundImage: "url(pillow.jpg)" }}
                  ></div>
                  <div className="login-wrap p-4 p-md-5">
                    ...
                    >
                      ...
                      <div className="form-group mb-3">
                        ...
                        <input
                          ...
                          className="form-control accountinput mt-2"
                          placeholder="Password"
                          defaultValue="What is your favourite food?"
                          disabled
                          required
                        />
                      </div>
                    ...
                    <p className="">
                      ...
                      <a data-toggle="tab" href="/login" className="ms-3">
                        Sign in
                      </a>
                    </p>
                  </div>
